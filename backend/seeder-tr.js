...
// Load models
const Trade = require('./models/Trade'); // Make sure to use the correct model
...
const CSV_FILE_PATH = path.join(__dirname, 'db-seed-tr.csv'); // Change this to your CSV file path
const MODEL_TO_SEED = Trade;
